...
FRINFO_PATH_DIR = '/home/user/frinfo'
FRINFO_PATH = f'{FRINFO_PATH_DIR}/FRinfo'
FRINFO_PATH_LOG = f'{FRINFO_PATH_DIR}/logs/FRinfo.log'
...
def set_params():
    ...
    fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_VALUE, 'k-server.1-ofd.ru')
    fptr.writeDeviceSetting()

    fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_ID, 1001)  # port ISM
    fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_VALUE, '7788')  # port ISM
    fptr.writeDeviceSetting()
